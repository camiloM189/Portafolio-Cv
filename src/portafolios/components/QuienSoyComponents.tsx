...
export const QuienSoyComponents = () => {
    return (	
        ...
        <h2 className="Franklin-Gothic-Medium quien-soy-h2">¿Quien Soy?</h2>
            ...
            impactantes. Habilidades sólidas en HTML,  CSS  y  JavaScript,
            con  un  enfoque   particular   en   el   ecosistema   de   React,
            incluyendo   Redux   y   React  Router  DOM.  Además,  poseo
            conocimientos   en   diseño   gráfico  utilizando  herramientas
            como Adobe Illustrator y Photoshop, lo que me permite crear
            experiencias de usuario cohesivas y visualmente atractivas.
            </p>
        </div>
    </article>		
    )	
